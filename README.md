...
| `robot_simulation` | Gazebo 世界、插件、故障注入 | 虚拟差速车和 AprilTag 场景 |

## 从这里开始

开发环境已验证后，先按 [第 2 步：编译并验证模拟底盘](docs/02_编译并验证模拟底盘.md) 启动无硬件的 ROS 2 底盘，再按 [第 3 步：在 RViz 查看模拟机器人](docs/03_RViz查看模拟机器人.md) 查看模型与运动。
